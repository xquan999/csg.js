...
it('color (rgb, on 3d objects)', function () {
...
//
// test.failing('color (rgb, on 2d objects)', function () {
...
it('color (rgba, on 3d objects)', function () {
...
// test.failing('color (rgba, on 2d objects)', function () {
...
it('color (rgba, on array of 3D objects)', function () {
  const obs = color([1, 0, 0, 0.5], [cube(), sphere()])
  const expColor = { color: [ 1, 0, 0, 0.5 ] }
...
// test.failing('color (rgba, on array of 2d objects)', function () {
//   const obs = color([1, 0, 0, 0.5], [square(), circle()])
//   const expColor = { color: [ 1, 0, 0, 0.5 ] }
//
//   t.deepEqual(obs.sides[0].shared, expColor)
...
it('color (by name, on 3d objects)', function () {
...
//
// test.failing('color (by name, on 2d objects)', function () {
...
it('color (by name and alpha, on 3d objects)', function () {
...
// test.failing('color (by name and alpha, on 2d objects)', function () {
...
it('color (by name and alpha, on array of 3d objects)', function () {
...
// test.failing('color (by name and alpha, on array of 2d objects)', function () {
